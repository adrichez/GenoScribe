...
#############################################################################################################################################################
# SCRIPT PARA CREAR LA ESTRUCTURA BASE DE DIRECTORIOS (SCAFFOLD) PARA UN PROYECTO DE METAGENÓMICA DE AMPLICONES
#############################################################################################################################################################
...
echo ""
title1 "###################################################################################################################################"
title1 "🚀${TAB_4}Creación de la estructura base de directorios para un proyecto Metagenómico de Amplificones"
title1 "###################################################################################################################################"
echo ""
...
DIRS=(
  # Bloque de Análisis (Control de calidad previo)
  "Analisis/miARma_16S/Pre_fastqc_results"
  "Analisis/miARma_18S/Pre_fastqc_results"
  "Analisis/miARma_ITS/Pre_fastqc_results"
  
  # Bloque de Análisis (Lecturas originales)
  "Analisis/reads/16S"
  "Analisis/reads/18S"
  "Analisis/reads/ITS"
  ...
  # Bloque de Resultados (16S)
  "Resultados/Def_16S/core-metrics-results"
  "Resultados/Def_16S/exported/familia"
  "Resultados/Def_16S/exported/genero"

  # Bloque de Resultados (18S)
  "Resultados/Def_18S/core-metrics-results"
  "Resultados/Def_18S/exported/familia"
  "Resultados/Def_18S/exported/genero"

  # Bloque de Resultados (ITS)
  "Resultados/Def_ITS/core-metrics-results"
  "Resultados/Def_ITS/exported/familia"
  "Resultados/Def_ITS/exported/genero"
)
...
title2 "≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠"
info "🔹${TAB_4}Tipo de análisis: Metagenómica de Amplicones"
