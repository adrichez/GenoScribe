...
#############################################################################################################################################################
# SCRIPT PARA CREAR LA ESTRUCTURA BASE DE DIRECTORIOS (SCAFFOLD) PARA UN PROYECTO DE METAGENÓMICA SHOTGUN
#############################################################################################################################################################
...
echo ""
title1 "###################################################################################################################################"
title1 "🚀${TAB_4}Creación de la estructura base de directorios para un proyecto Metagenómico ShotGun"
title1 "###################################################################################################################################"
echo ""
...
DIRS=(
  # Completar esta sección con la estructura de directorios deseada
)
...
title2 "≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠"
info "🔹${TAB_4}Tipo de análisis: Metagenómica de ShotGun"
