...
#############################################################################################################################################################
# SCRIPT PARA LIMPIAR EL DIRECTORIO DE TRABAJO DEL PIPELINE DE TRANSCRIPTOMICS SPATIAL CELL RNA-SEQ
#############################################################################################################################################################
...
FOLDERS_TO_EMPTY=(
  ...
  "resources/01-essential/02-archives/02-tmp/tab2-resumen"
  "resources/01-essential/02-archives/02-tmp/tab3-analisis"
  "resources/02-nextflow-results/01-project-data"
  "resources/02-nextflow-results/02-analisis-estadistico"
