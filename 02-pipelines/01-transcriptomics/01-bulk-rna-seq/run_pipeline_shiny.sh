...
#############################################################################################################################################################
# SCRIPT PARA LANZAR EL PIPELINE DE TRANSCRIPTÓMICA BULK RNA-SEQ MEDIANTE SHINY
#############################################################################################################################################################
...
echo ""
title1 "###################################################################################################################################"
title1 "🚀${TAB_4}[Transcriptomics - Bulk RNA-Seq Pipeline] Lanzando pipeline..."
title1 "###################################################################################################################################"
...
if [ $# -lt 3 ]; then
  ...
  error "  2️⃣${TAB_6}<experiment_name>  Nombre del experimento"
