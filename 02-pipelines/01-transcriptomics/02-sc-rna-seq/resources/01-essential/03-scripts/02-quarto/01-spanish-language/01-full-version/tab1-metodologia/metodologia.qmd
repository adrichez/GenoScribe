...
<p>
  Una vez completadas todas las etapas del flujo de análisis de <strong>Single-Cell RNA-Seq</strong> mediante las herramientas anteriormente vistas, los resultados se organizan en una <strong>estructura de directorios</strong> que sirve como base para la generación de este informe automatizado. 
