  ...
  if (length(files) == 0) {
    ...
    <p style="text-align:center; margin-bottom: 30px;">
      <a href="{ruta_scripts_main_relativa}" target="_blank" class="boton-files">
        <i class="fa-solid fa-folder-open"></i> Browse the files in the "{basename(ruta_scripts_main)}" folder here
      </a>
    </p>
    \n\n'))
  }
  ...
  if (length(files_func) == 0) {
    ...
    <p style="text-align:center; margin-bottom: 30px;">
      <a href="{ruta_scripts_functions_relativa}" target="_blank" class="boton-files">
        <i class="fa-solid fa-folder-open"></i> Browse the files in the "{basename(ruta_scripts_functions)}" folder here
      </a>
    </p>
    \n\n'))
  }
...
if (!dir.exists(ruta_sc_rna_seq_pipeline_absoluta)) {
  ...
  <b>Warning</b><br>
  The specified path does not exist or is not accessible:<br>
  <code>{ruta_sc_rna_seq_pipeline_absoluta}</code>
  </div>
  '))
  ...
  if (length(files) == 0) {
    ...
    <p style="text-align:center;">
      <a href="{enlace}" target="_blank" class="boton-files">
        <i class="fa-solid fa-folder-open"></i> Browse the files in the "{basename(ruta_sc_rna_seq_pipeline_absoluta)}" folder here
      </a>
    </p>
    \n\n'))
  }
