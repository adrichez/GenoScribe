...
<p>
  En el apartado <strong>1. Workflows y herramientas empleadas en la generación de resultados</strong>, se describe el pipeline principal, dividido en dos etapas fundamentales: un control de calidad inicial de las lecturas orquestado mediante <strong>miARma-Seq</strong>, seguido de un análisis metagenómico detallado llevado a cabo con <strong>QIIME 2</strong> y el lenguaje <strong>R</strong> para el procesamiento diferencial de los marcadores seleccionados (16S, 18S o ITS). A continuación, en <strong>2. Estructura de los datos y resultados generados</strong>, se detalla la organización de los directorios de salida y los archivos clave resultantes del experimento. 
</p>
