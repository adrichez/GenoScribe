...
for (f in archivos_csv) {
  ...
  out_html <- tagAppendChild(out_html, HTML(glue::glue('
    ...
    <div class="titulo4" id="tab3-seccion4.1.2.{nivel_titulo}" style="padding-bottom: 8px; line-height: 1.2;">
      4.1.2.{nivel_titulo}. Tabla interactiva de abundancia de ASVs por nivel taxonómico {nivel}
    </div>
  ...
  if (file.exists(f)) {
    ...
    out_html <- tagAppendChild(out_html, HTML(glue::glue('
      <div class="alert-info alert-box" style="margin-bottom: 30px;">
        <i class="fa-solid fa-triangle-exclamation"></i> El archivo "level-{nivel}.csv" no se encontró en la ruta especificada: {f}
      </div>
    ')))
  }
}
