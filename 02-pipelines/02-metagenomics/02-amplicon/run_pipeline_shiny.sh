...
#############################################################################################################################################################
# SCRIPT PARA LANZAR EL PIPELINE DE METAGENÓMICA DE AMPLICONES MEDIANTE SHINY
#############################################################################################################################################################
...
echo ""
title1 "###################################################################################################################################"
title1 "🚀${TAB_4}[Metagenomics - Amplicon Pipeline] Lanzando pipeline..."
title1 "###################################################################################################################################"
...
if [ $# -lt 3 ]; then
  ...
  error "≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠"
  error "Este script necesita 3 parámetros para ejecutarse correctamente:"
  error "  1️⃣${TAB_6}<project_path>  Ruta a los datos del proyecto"
  error "  2️⃣${TAB_6}<amplicon_type>  Tipo de análisis (16S, 18S, ITS, etc.)"
...
info "🧪${TAB_4}Tipo de análisis metagenómico: $AMPLICON_TYPE"
